...
export default class AddCarExperienceAura extends LightningElement {
    ...
    addExperience(){
        ...
        createRecord(recordInput).then( carExperience =>{
            ...
            const addCarExprecord = new CustomEvent('experienceadded');
            this.dispatchEvent(addCarExprecord);
        }).catch( error => {
