...
export default class ForShowingPurpose3 extends LightningElement {
             ...
             listOfFields.map(element=>{
                 ...
                 if(this.firstColumnAsRecordHyperLink !=null && this.firstColumnAsRecordHyperLink=='Yes'
                     ...
                     items = [...items ,
                               ...
                               listOfFields.map(element=>{
                                //it will enter this if-block just once
                                if(this.secondColumnAsRecordHyperLink !=null && this.secondColumnAsRecordHyperLink=='Yes'
                                                                        && secondTimeEntry==false){
                                    secondFieldAPI  = element.fieldPath; 
                                    //perpare first column as hyperlink                                     
                                    items = [...items ,
                                                    {
                                                        label: element.label, 
