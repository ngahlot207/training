...
export default class CarDetailsAura extends LightningElement {
    ...
    carExperienceHandler(){
        const carExperienceComp = this.template.querySelector('c-view-car-experience-aura');
    ...
    get carFound(){
        console.log('>>carFound1>>'+this.car.data);
        if(this.car.data){
            console.log('>>carFound2>>');
            return true;
        }
        return false;
    }
